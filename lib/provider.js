...
(function() {
  ...
  Provider = (function() {
    ...
    Provider.prototype._valid_parameters = function(body) {
      var has_resource_link_id, omits_content_item_params;
      if (!body) {
        return false;
      }
      ...
      return (body.lti_message_type === 'basic-lti-launch-request' && has_resource_link_id) || (body.lti_message_type === 'ContentItemSelectionRequest' && omits_content_item_params);
    };
